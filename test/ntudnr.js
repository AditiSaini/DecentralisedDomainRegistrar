...
*/
    ...
    it("First user pass in an invalid value and should not get refund", async() =>{
        let ntudnr = await ntuDNR.deployed();
        let domain = "dnwang.ntu";
        let result = await ntudnr.reveal.call(domain,0,false,"0xc89efdaa54c0f20c7adf612882df0950f5a951637e0307cdcb4c672f298b8bc6",
            {from: accounts[0]});
    ...
    it ("Both users pass in correct values and should return the correct top bid", async() =>{
        let ntudnr = await ntuDNR.deployed();
        let domain = "dnwang.ntu";
        let result_0 = await ntudnr.reveal(domain,1,false,"0xc89efdaa54c0f20c7adf612882df0950f5a951637e0307cdcb4c672f298b8bc6",
                {from:accounts[0]});
        let result_1 = await ntudnr.reveal(domain,3,false,"0x2a80e1ef1d7842f27f2e6be0972bb708b9a135c38860dbe73c27c3486c34f4de",
            {from:accounts[1]});
